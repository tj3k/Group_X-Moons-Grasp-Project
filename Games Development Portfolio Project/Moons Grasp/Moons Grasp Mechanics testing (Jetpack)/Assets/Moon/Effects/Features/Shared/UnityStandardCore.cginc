...
//adam-begin: feature dependencies
#if defined(ATMOSPHERICS) || defined(ATMOSPHERICS_PER_PIXEL)
...
//adam-begin: shader additions
#if defined(ATMOSPHERICS) || defined(ATMOSPHERICS_PER_PIXEL)
	VOLUND_TRANSFER_SCATTER(posWorld, o);
#endif
//adam-end:
...
//adam-begin:
	// TODO: Actually move over usable double-sided code.
	if(_CullMode == 0 && !frontFace)
		i.tangentToWorldAndParallax[2].xyz = -i.tangentToWorldAndParallax[2].xyz;
//adam-end:
...
//adam-begin:
	outNormal.a -= _HasTransmission == 0 ? saturate(tex2D(_TransmissionThicknessMap, i.tex.xy).r * _TransmissionThicknessScale) : 0.f;
//adam-end:
